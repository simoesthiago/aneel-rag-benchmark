...
def test_query_submodulo_id_extrai_identificador():
    ...
    assert query_submodulo_id("coberta pelo Submódulo 2.10-RQ") == "2-10"
...
def test_doc_matches_2_1_nao_casa_2_1a_nem_2_10():
    ...
    assert doc_matches_submodulo("proret-modulo02-subm2-1-proret-submod-2-1-v-2-5", ident)
    # 2.1A (RI) — NÃO pode casar
    assert not doc_matches_submodulo("proret-modulo02-subm2-1a-proret-submod-2-1a", ident)
    # 2.10 — NÃO pode casar
